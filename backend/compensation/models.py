...
class CompensationCase(models.Model):
    ...
    submitted_by = models.ForeignKey(
        'accounts.User', on_delete=models.PROTECT, related_name='submitted_cases'
    )
    ...
    hq_reviewed_by = models.ForeignKey(
        'accounts.User', on_delete=models.SET_NULL,
        null=True, blank=True, related_name='hq_reviewed_cases'
    )
    hq_reviewed_at = models.DateTimeField(null=True, blank=True)
    hq_comments    = models.TextField(blank=True, default='')

    meeting_date = models.DateField(null=True, blank=True)

    igp_approved_by    = models.ForeignKey(
        'accounts.User', on_delete=models.SET_NULL,
    ...
    so_reviewed_by  = models.ForeignKey(
        'accounts.User', on_delete=models.SET_NULL,
...
class CaseDocument(models.Model):
    case              = models.ForeignKey(
        CompensationCase, on_delete=models.CASCADE, related_name='documents'
    )
    ...
    verified_by = models.ForeignKey(
        'accounts.User', on_delete=models.SET_NULL,
        null=True, blank=True, related_name='verified_docs'
    )
    ...
    rejected_by      = models.ForeignKey(
        'accounts.User', on_delete=models.SET_NULL,
        null=True, blank=True, related_name='rejected_docs'
    )
    ...
    def __str__(self):
        return f"{self.case.case_id} — {self.doc_type}"
...
class CommitteeMember(models.Model):
    case = models.ForeignKey(
        CompensationCase, on_delete=models.CASCADE, related_name='committee_members'
    )
    user = models.ForeignKey(
        'accounts.User', on_delete=models.PROTECT, related_name='committee_assignments'
    )
    role        = models.CharField(max_length=30, choices=COMMITTEE_ROLE_CHOICES)
    assigned_by = models.ForeignKey(
        'accounts.User', on_delete=models.SET_NULL,
        null=True, related_name='committees_formed'
    )
...
class MemberAssessmentInput(models.Model):
    case             = models.ForeignKey(
        CompensationCase, on_delete=models.CASCADE, related_name='member_inputs'
    )
    committee_member = models.OneToOneField(
        CommitteeMember, on_delete=models.CASCADE, related_name='assessment_input'
    )
...
class Assessment(models.Model):
    case                    = models.OneToOneField(
        CompensationCase, on_delete=models.CASCADE, related_name='assessment'
    )
    formula                 = models.ForeignKey(
        CompensationFormula, on_delete=models.PROTECT, null=True, blank=True
    )
...
class AuditLog(models.Model):
    case        = models.ForeignKey(
        CompensationCase, on_delete=models.CASCADE, related_name='audit_logs'
    )
...
class Notification(models.Model):
    case      = models.ForeignKey(
        CompensationCase, on_delete=models.CASCADE, related_name='notifications'
    )
    recipient = models.ForeignKey(
        'accounts.User', on_delete=models.CASCADE, related_name='comp_notifications'
    )
